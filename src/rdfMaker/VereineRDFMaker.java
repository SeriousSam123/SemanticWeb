...
public class VereineRDFMaker {
    ...
    private OntModel makeRDFGraph(List<Verein> vereine){
        ...
        // Property: Name des Ortes
        DatatypeProperty vereinOrtProperty = m.createDatatypeProperty(gn + "name");
        vereinOrtProperty.addDomain(vereinClass);
        vereinOrtProperty.addRange(XSD.xstring);
        vereinOrtProperty.addComment("Name des Ortes", "DE");
